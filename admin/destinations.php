                            ...
                            <div class="space-y-3">
                                ...
                                <div class="flex items-center space-x-8 p-6 bg-slate-50 rounded-3xl border-2 border-dashed border-slate-200">
                                    <?php if (isset($editItem['image_path'])): ?>
                                        <img id="destPreview" src="../<?php echo $editItem['image_path']; ?>" class="w-32 h-24 rounded-2xl object-cover shadow-md">
                                    <?php else: ?>
                                        <img id="destPreview" src="../assets/img/ethiopia.jpg" class="w-32 h-24 rounded-2xl object-cover shadow-md">
                                    <?php endif; ?>
                                    <input type="file" name="image" onchange="openCropModal(this, document.getElementById('destPreview'), 4/3)" class="text-sm text-slate-500 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-xs file:font-black file:bg-primary file:text-white hover:file:bg-primary/80 transition-all">
                                </div>
                            </div>
