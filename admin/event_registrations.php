                            ...
                            <div id="modal-<?php echo $r['id']; ?>" class="fixed inset-0 z-[999] hidden items-center justify-center modal-backdrop">
                                <div class="bg-white rounded-[40px] max-w-3xl w-full mx-4 max-h-[90vh] overflow-y-auto shadow-2xl p-10 md:p-14 relative">
                                    ...
                                    <div class="grid grid-cols-2 gap-x-8 gap-y-5 text-sm">
                                        ...
                                        <div><span class="text-[10px] font-black text-slate-400 uppercase tracking-widest block mb-1">Visa Support</span><span class="font-bold <?php echo $r['requires_visa'] ? 'text-amber-600' : 'text-secondary'; ?>"><?php echo $r['requires_visa'] ? 'Yes' : 'No'; ?></span></div>
                                        ...
                                        <div><span class="text-[10px] font-black text-slate-400 uppercase tracking-widest block mb-1">Arrival Date</span><span class="font-bold text-secondary"><?php echo !empty($r['arrival_date']) ? date('M d, Y', strtotime($r['arrival_date'])) : '-'; ?></span></div>
                                        <div><span class="text-[10px] font-black text-slate-400 uppercase tracking-widest block mb-1">Departure Date</span><span class="font-bold text-secondary"><?php echo !empty($r['departure_date']) ? date('M d, Y', strtotime($r['departure_date'])) : '-'; ?></span></div>
                                        <div><span class="text-[10px] font-black text-slate-400 uppercase tracking-widest block mb-1">Arrival City/Airport</span><span class="font-bold text-secondary"><?php echo !empty($r['arrival_city']) ? $r['arrival_city'] : '-'; ?></span></div>
                                        <div><span class="text-[10px] font-black text-slate-400 uppercase tracking-widest block mb-1">Flight Number</span><span class="font-bold text-secondary"><?php echo !empty($r['arrival_flight']) ? $r['arrival_flight'] : '-'; ?></span></div>
                                        ...
                                        <div><span class="text-[10px] font-black text-slate-400 uppercase tracking-widest block mb-1">Visa Document</span><span class="font-bold text-secondary"><?php echo !empty($r['visa_support_doc_path']) ? '<a class="text-primary underline" target="_blank" href="../' . $r['visa_support_doc_path'] . '">View</a>' : '-'; ?></span></div>
                                        ...
                                        <div><span class="text-[10px] font-black text-slate-400 uppercase tracking-widest block mb-1">Vaccination Document</span><span class="font-bold text-secondary"><?php echo !empty($r['vaccination_doc_path']) ? '<a class="text-primary underline" target="_blank" href="../' . $r['vaccination_doc_path'] . '">View</a>' : '-'; ?></span></div>
                                        <div><span class="text-[10px] font-black text-slate-400 uppercase tracking-widest block mb-1">Additional Document</span><span class="font-bold text-secondary"><?php echo !empty($r['additional_doc_path']) ? '<a class="text-primary underline" target="_blank" href="../' . $r['additional_doc_path'] . '">View</a>' : '-'; ?></span></div>
